...
def split_Train_Val_Data(imgpath, maskpath, batch_size=16):
    ...
    train_dataloader = DataLoader(CellDataset(
        train_inputs, train_labels), batch_size=batch_size, shuffle=True)
    val_dataloader = DataLoader(CellDataset(
        val_inputs, val_labels), batch_size=batch_size, shuffle=False)
